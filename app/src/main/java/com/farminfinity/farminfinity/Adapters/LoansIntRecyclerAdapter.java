...
import com.farminfinity.farminfinity.Fragments.RecyclerViewEmiIntFragment;
...
public class LoansIntRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public LoansIntRecyclerAdapter(Context context, RecyclerView recyclerView, final ArrayList<LoanModel> processedData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new LoansIntRecyclerAdapter.ItemViewHolder(view);

        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.list_item_loading, parent, false);
            return new LoansIntRecyclerAdapter.LoadingViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof LoansIntRecyclerAdapter.ItemViewHolder) {
            LoanModel loanModel = (LoanModel) processedData.get(position);
            final ItemViewHolder viewHolder = (ItemViewHolder) holder;
            viewHolder.loanIds.setText(loanModel.getLoan_id());
        } else {
            LoansIntRecyclerAdapter.LoadingViewHolder loadingViewHolder = (LoansIntRecyclerAdapter.LoadingViewHolder) holder;
    ...
    private class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            // Open form
            RecyclerViewEmiIntFragment nextFrag = new RecyclerViewEmiIntFragment();
