...
public class EditFinalSubmitFragment extends BaseFragment {
    ...
    private TextView tvFarmerDeclarationTxt;
    private TextView tvOfficerDeclarationTxt;
    ...
    public EditFinalSubmitFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit_final_submit, container, false);
        ...
        coordinatorLayout = (CoordinatorLayout) view.findViewById(R.id.cl_fragment_edit_final_submit);
        llOfficerDeclaration = (LinearLayout) view.findViewById(R.id.ll_officer_decl_fragment_edit_final_submit);

        tvFarmerDeclarationTxt = (TextView) view.findViewById(R.id.et_farmer_decl_fragment_edit_final_submit);
        tvOfficerDeclarationTxt = (TextView) view.findViewById(R.id.et_officer_decl_fragment_edit_final_submit);

        cbFarmerDeclaration = (CheckBox) view.findViewById(R.id.cb_farmer_declaration_fragment_edit_final_submit);
        cbOfficerDeclaration = (CheckBox) view.findViewById(R.id.cb_officer_declaration_fragment_edit_final_submit);

        cvBtnSubmit = (CardView) view.findViewById(R.id.cv_btn_save_fragment_edit_final_submit);
    ...
    private void InitData(){
        ...
        if (userType.equals("farmer"))
            url = EndPoints.URL_FARMER_GET_LEVEL_END;
        else if (userType.equals("officer")) {
            switch (intUserType) {
                case 1:// FIE
                    url = EndPoints.URL_EMP_GET_LEVEL_END + fId;
                    break;
                case 2:
                    url = EndPoints.URL_AGENT_GET_LEVEL_END + fId;
                    break;
                case 3:
                    url = EndPoints.URL_FPO_GET_LEVEL_END + fId;
                    break;
                case 4:
                    url = EndPoints.URL_BANK_REP_GET_LEVEL_END + fId;
                    break;
                default:
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (data!=null) {
                                ...
                                if (isLevelDone){
                                    if (userType.equals("farmer")){
                                        cbFarmerDeclaration.setChecked(data.getBoolean("farmer_declaration"));
                                    }else if (userType.equals("officer")){
                                        cbFarmerDeclaration.setChecked(data.getBoolean("farmer_declaration"));
                                        cbOfficerDeclaration.setChecked(data.getBoolean("officer_declaration"));
                                    }
                                }
                            }
    ...
    private void AddData() {
        ...
        try {
            ...
            if (userType.equals("farmer")) {
                ...
                jsonBody.put("farmer_declaration_text", tvFarmerDeclarationTxt.getText().toString().trim());
            } else if (userType.equals("officer")) {
                jsonBody.put("user_id", fId);
                jsonBody.put("farmer_declaration", cbFarmerDeclaration.isChecked());
                jsonBody.put("officer_declaration", cbOfficerDeclaration.isChecked());
                jsonBody.put("farmer_declaration_text", tvFarmerDeclarationTxt.getText().toString().trim());
                jsonBody.put("officer_declaration_text", tvOfficerDeclarationTxt.getText().toString().trim());
            }
    ...
    private void EditData() {
        String url = "";
        if (userType.equals("farmer")) {
            url = EndPoints.URL_FARMER_UPDATE_FORM_END;
        } else if (userType.equals("officer")) {
            switch (intUserType) {
                case 1:// FIE
                    url = EndPoints.URL_EMP_UPDATE_FORM_END + fId;
                    break;
                case 2:
                    url = EndPoints.URL_AGENT_UPDATE_FORM_END + fId;
                    break;
                case 3:
                    url = EndPoints.URL_FPO_UPDATE_FORM_END + fId;
                    break;
                case 4:
                    url = EndPoints.URL_BANK_REP_UPDATE_FORM_END + fId;
                    break;
                default:
                    Toast.makeText(getActivity(), "Invalid userid!", Toast.LENGTH_SHORT).show();
                    break;
